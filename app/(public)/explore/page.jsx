...
const ExplorePage = () => {
  ...
  const { data: featuredEvents, isLoading: isFeaturedLoading } = useConvexQuery(
  ...
  const { data: categoriesCounts } = useConvexQuery(
  ...
  const categoriesWithCount = CATEGORIES.map((cat) => {
    return {
      ...cat,
      count: categoriesCounts?.[cat.id] || 0,
    };
  });
  ...
  const handleViewLocalEvents = () => {
    const city = currentUser?.location?.city || "Gorakhpur";
    ...
    <>
      <div className="pb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          Discover and participate in events happening around you
        </p>
      </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                {currentUser?.location?.city || "your location"}
              </p>
            </div>
      ...
      {/* popular event accross countery  */}
