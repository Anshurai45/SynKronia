...
const EventCard = ({
  ...
  if (variant === "list") {
    return (
      <Card
        className={
          "py-0 group cursor-pointer hover:shadow-lg transition-all hover:border-purple-500/50 ${className}"
        }
        onClick={onClick}
      >
          ...
          <div className="w-20 h-20 rounded-lg shrink-0 overflow-hidden relative">
            {event.coverImage ? (
              ...
              <div
                ...
                style={{ backgroundColor: event.category }}
              >
  ...
  return (
    <Card
      className={
        'overflow-hidden group pt-0 ${onClick ? "cursor-pointer hover:shadow-lg transition-all hover:border-purple-500/50 : ""} ${className}'
      }
      onClick={onClick}
    >
